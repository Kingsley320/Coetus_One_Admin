    ...
    return (
        <> 
            <div className="h-screen w-56 rounded-ee-2xl rounded-tr-2xl  py-8 bg-orange-600 text-white fixed top-0 z-10">
                ...
                <div>
                    <Link to="/" className="w-full flex gap-4 my-1 py-3 px-5 hover:bg-orange-800 group focus:pl-14 focus:bg-orange-800"><BsColumnsGap className="text-lg my-auto group-hover:scale-125 group-focus:scale-125 " /> Dashboard</Link>
